...
const variants: Record<Variant, string> = {
  ...
  secondary: 'border bg-gray-100 hover:bg-gray-200 text-gray-700 border-gray-200 dark:bg-slate-800 dark:hover:bg-slate-700 dark:text-slate-200 dark:border-slate-700',
